...
public class SwappingNoiseInjectorTest {

    SwappingNoiseInjector swappingNoiseInjector = new SwappingNoiseInjector();
    ...
    public void testSwapActivities() {
        Exception exception1 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapActivities(new Trace(), 2, 0, 1));
        String expectedMessage1 = "The trace must be longer than twice the length of the subtrace to swap.";
        String actualMessage1 = exception1.getMessage();
        assertTrue(actualMessage1.contains(expectedMessage1));

        Exception exception2 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapActivities(cleanTrace, 2, -1, 2));
        String expectedMessage2 = "Invalid first index.";
        String actualMessage2 = exception2.getMessage();
        assertTrue(actualMessage2.contains(expectedMessage2));

        Exception exception3 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapActivities(cleanTrace, 2, 4, 5));
        String expectedMessage3 = "Invalid first index.";
        String actualMessage3 = exception3.getMessage();
        assertTrue(actualMessage3.contains(expectedMessage3));

        Exception exception4 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapActivities(cleanTrace, 2, 0, 1));
        ...
        Exception exception5 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapActivities(cleanTrace, 2, 2, 2));
        ...
        Exception exception6 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapActivities(cleanTrace, 2, 2, 5));
        ...
        swappingNoiseInjector.swapActivities(cleanTrace, 3, 0, 3);
        assertEquals(cleanTrace, new Trace(Arrays.asList("d", "e", "f", "a", "b", "c")));
    }

    @Test
    public void testSwapRandomActivities() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapActivities(new Trace(), 2));
        String expectedMessage = "The trace must be longer than twice the length of the subtrace to swap.";
        String actualMessage = exception.getMessage();
        assertTrue(actualMessage.contains(expectedMessage));

        int length = 2;
        swappingNoiseInjector.swapActivities(cleanTrace, length);
    ...
    public void testSwapTwoRandomActivities() {
        Exception exception = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapTwoActivities(new Trace(), 0, 1));
        String expectedMessage = "The trace must be longer than two to swap.";
        String actualMessage = exception.getMessage();
        assertTrue(actualMessage.contains(expectedMessage));

        swappingNoiseInjector.swapTwoActivities(cleanTrace, 0, 4);
        assertEquals(cleanTrace, new Trace(Arrays.asList("e", "b", "c", "d", "a", "f")));
    }

    @Test
    public void testSwapAdjacentActivities() {
        Exception exception1 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapAdjacentActivities(cleanTrace, 5, 1));
        String expectedMessage1 = "The trace must be longer than twice the length of the subtrace to swap.";
        String actualMessage1 = exception1.getMessage();
        assertEquals(actualMessage1, expectedMessage1);

        Exception exception2 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapAdjacentActivities(cleanTrace, 3, -1));
        String expectedMessage2 = "Invalid index provided.";
        String actualMessage2 = exception2.getMessage();
        assertEquals(actualMessage2, expectedMessage2);

        Exception exception3 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapAdjacentActivities(cleanTrace, 3, 1));
        String expectedMessage3 = "Invalid index provided.";
        String actualMessage3 = exception3.getMessage();
        assertEquals(actualMessage3, expectedMessage3);

        Exception exception4 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapAdjacentActivities(cleanTrace, 3, 7));
        String expectedMessage4 = "Invalid index provided.";
        String actualMessage4 = exception4.getMessage();
        assertEquals(actualMessage4, expectedMessage4);

        swappingNoiseInjector.swapAdjacentActivities(cleanTrace, 3, 0);
        assertEquals(cleanTrace, new Trace(Arrays.asList("d", "e", "f", "a", "b", "c")));

        swappingNoiseInjector.swapAdjacentActivities(cleanTrace, 3, 3);
        assertEquals(cleanTrace, new Trace(Arrays.asList("a", "b", "c", "d", "e", "f")));
    }

    @Test
    public void testSwapTwoAdjacentActivities() {
        Exception exception1 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapTwoAdjacentActivities(new Trace(), 1));
        String expectedMessage1 = "The trace must be longer than two to swap.";
        String actualMessage1 = exception1.getMessage();
        assertEquals(actualMessage1, expectedMessage1);

        Exception exception2 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapTwoAdjacentActivities(cleanTrace, cleanTrace.size()));
        String expectedMessage2 = "Invalid index.";
        String actualMessage2 = exception2.getMessage();
        assertTrue(actualMessage2.contains(expectedMessage2));

        Exception exception3 = assertThrows(IllegalArgumentException.class, () -> swappingNoiseInjector.swapTwoAdjacentActivities(cleanTrace, -1));
        String expectedMessage3 = "Invalid index.";
        String actualMessage3 = exception3.getMessage();
        assertTrue(actualMessage3.contains(expectedMessage3));

        swappingNoiseInjector.swapTwoAdjacentActivities(cleanTrace, 1);
        assertEquals(cleanTrace, new Trace(Arrays.asList("a", "c", "b", "d", "e", "f")));

        swappingNoiseInjector.swapTwoAdjacentActivities(cleanTrace, 5);
